...
export const PRO_FAQ: readonly FaqEntry[] = [
  ...
  },
  {
    ...
    answer:
      "בדקו שהמתג ״זמין לקריאות״ דלוק, שרדיוס הפעילות לא צר מדי, ושתחומי ההתמחות בפרופיל מעודכנים. קריאה מגיעה אליכם רק אם היא בתוך הרדיוס שלכם וגם בתוך הרדיוס שהלקוח ביקש. כיבוי המתג מפסיק גם את ההתראות על קריאות חדשות, כי אותו תנאי בדיוק נבדק בשני המקומות.",
  },
  {
