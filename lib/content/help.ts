...
export const PRO_FAQ: readonly FaqEntry[] = [
  ...
  },
  {
    ...
    answer:
      "יש לכם שעתיים לאשר שאתם לוקחים את העבודה, מהמסך ״ההצעות שלי״ או מלוח הבקרה. ברגע האישור העבודה משובצת אליכם, שאר ההצעות על הקריאה נסגרות, ונגבים דמי קבלת העבודה. אם לא תאשרו בזמן — הקריאה חוזרת ללקוח והוא יכול לבחור מישהו אחר. גם ויתור מפורש אפשרי, והוא לא עולה כלום.",
  },
  {
