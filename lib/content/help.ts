...
export const CUSTOMER_FAQ: readonly FaqTopic[] = [
  {
    ...
    entries: [
      ...
      },
      {
        ...
        answer:
          "אם תוך חצי שעה לא הגיעה הצעה, נשלח לכם הודעה. תמונה או עוד כמה פרטים — אפשר להוסיף אותם ממסך הקריאה — עוזרים לבעלי מקצוע לתמחר. ואפשר תמיד לפנות לתמיכה.",
      },
      {
        question: "אפשר לבטל קריאה?",
        answer:
          "כן. עד שבעל מקצוע אישר את הקריאה, מבטלים ממסך הקריאה — ללא עלות, והצעות שהתקבלו נסגרות. אחרי שבעל מקצוע אישר, כתבו על כך בצ׳אט, והביטול יסומן במסך העבודה — או פנו לתמיכה.",
      },
      {
...
export const PRO_FAQ: readonly FaqEntry[] = [
  {
    ...
    answer:
      "התשלום נגבה על ידך ישירות מהלקוח בשטח — Handy אינה צד לתשלום. מה שנרשם אצלנו הוא איך נגבה, כדי להנפיק קבלה.",
  },
  {
    // job_acceptance_fee() — one function, so the wallet, the bid form and the
    // receipt cannot drift apart.
    question: "כמה זה עולה לי, ועל מה בדיוק?",
    answer:
      "35 ₪ קבועים על כל עבודה שאישרתם, ללא תלות בגובה העבודה. הם נגבים ברגע האישור — לא בסיום העבודה — ואינם מוחזרים. אין דמי הרשמה, אין דמי מנוי, אין תשלום על הצעה שלא נבחרה, ואין תשלום על קריאה שוויתרתם עליה.",
  },
  {
    // select_bid() offers; accept_job() is what assigns and charges.
    question: "הלקוח בחר בי — מה עכשיו?",
    answer:
      "יש לכם שעתיים לאשר שאתם לוקחים את העבודה, מהמסך ״ההצעות שלי״ או מלוח הבקרה. ברגע האישור העבודה משובצת אליכם, שאר ההצעות על הקריאה נסגרות, ונגבים דמי קבלת העבודה. אם לא תאשרו בזמן — הקריאה חוזרת ללקוח והוא יכול לבחור מישהו אחר. גם ויתור מפורש אפשרי, והוא לא עולה כלום. אם אישרתם התראות בדפדפן, תגיע התראה ברגע שנבחרתם ועוד אחת כשנותרה חצי שעה — כדאי לאשר אותן, כי בלעדיהן צריך שהטאב יהיה פתוח.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "בדקו שהמתג ״זמין לקריאות״ דלוק, שרדיוס הפעילות לא צר מדי, ושתחומי ההתמחות בפרופיל מעודכנים. קריאה מגיעה אליכם אם היא בתוך הרדיוס שלכם, או אם לקוח ביקש אתכם ישירות דרך הקישור האישי. כיבוי המתג מפסיק גם את ההתראות על קריאות חדשות, כי אותו תנאי בדיוק נבדק בשני המקומות.",
  },
  {
